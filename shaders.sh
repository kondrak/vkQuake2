...
glslangValidator --variable-name nullmodel_frag_spv -V shaders/nullmodel.frag -o ref_vk/spirv/nullmodel_frag.c
...
glslangValidator --variable-name particle_frag_spv -V shaders/particle.frag -o ref_vk/spirv/particle_frag.c
...
glslangValidator --variable-name beam_frag_spv -V shaders/beam.frag -o ref_vk/spirv/beam_frag.c
...
glslangValidator --variable-name d_light_frag_spv -V shaders/d_light.frag -o ref_vk/spirv/d_light_frag.c
...
glslangValidator --variable-name polygon_warp_frag_spv -V shaders/polygon_warp.frag -o ref_vk/spirv/polygon_warp_frag.c
