...
//		"[Rendition OpenGL]",
	...
	for ( i = 0; i < 3; i++ )
	{
		...
		s_mode_list[i].generic.y = 10 * con_hudscale->value;
		s_mode_list[i].itemnames = resolutions;

		s_screensize_slider[i].generic.type	= MTYPE_SLIDER;
		s_screensize_slider[i].generic.x		= 0;
		s_screensize_slider[i].generic.y		= 20 * con_hudscale->value;
		...
		s_brightness_slider[i].generic.y	= 30 * con_hudscale->value;
		...
		s_fs_box[i].generic.y	= 40 * con_hudscale->value;
	...
	s_tq_slider.generic.y		= 60 * con_hudscale->value;
	...
	s_tqvk_slider.generic.y = 60 * con_hudscale->value;
	...
	s_paletted_texture_box.generic.y	= 70 * con_hudscale->value;
	...
	s_msaa_mode.generic.y = 70 * con_hudscale->value;
	s_msaa_mode.itemnames = msaa_modes;
	s_msaa_mode.curvalue = vk_msaa->value;

	s_finish_box.generic.type = MTYPE_SPINCONTROL;
	s_finish_box.generic.x	= 0;
	s_finish_box.generic.y	= 80 * con_hudscale->value;
	...
	s_vkfinish_box.generic.y = 80 * con_hudscale->value;
	...
	s_opengl_menu.x -= 8 * con_hudscale->value;
	s_software_menu.x -= 8 * con_hudscale->value;
	s_vulkan_menu.x -= 8 * con_hudscale->value;
}
...
void VID_MenuDraw (void)
{
	...
	*/
	...
	re.DrawPic( viddef.width / 2 - w * con_hudscale->value / 2, viddef.height /2 - 110 * con_hudscale->value, "m_banner_video" );
