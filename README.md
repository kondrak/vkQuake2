...
- some Intel GPUs may ignore texture filtering settings in video menu if anisotropic filtering is enabled - this is in fact a result of anisotropic texture filtering being implementation dependent
