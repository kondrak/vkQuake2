...
- 1920x1080 and 2560x1440 screen resolutions have been added
...
| vk_device             | Specifiy preferred Vulkan device index on systems with multiple GPUs.<br>-1 - prefer first DISCRETE_GPU (default)<br>0..n - use device #n (number depends on how many GPUs the system has) |
